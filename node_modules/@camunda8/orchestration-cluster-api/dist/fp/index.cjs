...
var fp_exports = {};
__export(fp_exports, {
  classifyDomainError: () => classifyDomainError,
  createCamundaFpClient: () => createCamundaFpClient,
  eventuallyTE: () => eventuallyTE,
  foldDomainError: () => foldDomainError,
  isLeft: () => isLeft,
  isRight: () => isRight,
  retryTE: () => retryTE,
  withTimeoutTE: () => withTimeoutTE
});
module.exports = __toCommonJS(fp_exports);

...
__export(index_exports, {
  ...
  CamundaValidationError: () => CamundaValidationError,
  ...
  EndCursor: () => EndCursor,
  EventualConsistencyTimeoutError: () => EventualConsistencyTimeoutError,
  FormId: () => FormId,
  FormKey: () => FormKey,
  IncidentKey: () => IncidentKey,
  JobActionReceiptSymbol: () => JobActionReceipt,
  JobKey: () => JobKey,
  ...
  createCamundaClientLoose: () => createCamundaClientLoose,
  createCamundaFpClient: () => createCamundaFpClient,
  createCamundaResultClient: () => createCamundaResultClient,
...
var zLongKey = import_zod.z.string().min(1).max(25).regex(/^-?[0-9]+$/).register(import_zod.z.globalRegistry, {
  description: "Zeebe Engine resource key (Java long serialized as string)"
});
var zStartCursor = import_zod.z.string().min(2).max(300).regex(/^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}(?:==)?|[A-Za-z0-9+/]{3}=)?$/).register(import_zod.z.globalRegistry, {
  description: "The start cursor in a search query result set."
});
var zEndCursor = import_zod.z.string().min(2).max(300).regex(/^(?:[A-Za-z0-9+/]{4})*(?:[A-Za-z0-9+/]{2}(?:==)?|[A-Za-z0-9+/]{3}=)?$/).register(import_zod.z.globalRegistry, {
...
var zResourceKey = import_zod.z.union([
...
var zBatchOperationKey = import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zTenantId = import_zod.z.string().min(1).max(256).regex(/^(<default>|[A-Za-z0-9_@.+-]+)$/).register(import_zod.z.globalRegistry, {
  description: "The unique identifier of the tenant."
});
var zTenantCreateResult = import_zod.z.object({
...
var zTenantUpdateRequest = import_zod.z.object({
  name: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zTenantResult = import_zod.z.object({
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zSortOrderEnum = import_zod.z.enum([
  "ASC",
  "DESC"
]).register(import_zod.z.globalRegistry, {
  description: "The order in which to sort the related field."
});
var zTenantSearchQuerySortRequest = import_zod.z.object({
  ...
  order: import_zod.z.optional(zSortOrderEnum)
});
var zOffsetPagination = import_zod.z.object({
  from: import_zod.z.optional(import_zod.z.int().gte(0).register(import_zod.z.globalRegistry, {
    description: "The index of items to start searching from."
  })).default(0),
  limit: import_zod.z.optional(import_zod.z.int().gte(1).register(import_zod.z.globalRegistry, {
    description: "The maximum number of items to return in one request."
  })).default(100)
});
var zCursorForwardPagination = import_zod.z.object({
  after: zEndCursor,
  limit: import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "The maximum number of items to return in one request."
  })).default(100)
});
...
var zSearchQueryPageRequest = import_zod.z.union([
  zOffsetPagination,
  zCursorForwardPagination,
  zCursorBackwardPagination
]);
var zSearchQueryRequest = import_zod.z.object({
  page: import_zod.z.optional(zSearchQueryPageRequest)
});
var zTenantFilter = import_zod.z.object({
  tenantId: import_zod.z.optional(zTenantId),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the tenant."
  }))
...
var zTenantSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zTenantSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zTenantFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Tenant search request"
}));
var zSearchQueryPageResponse = import_zod.z.object({
  totalItems: import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
    description: "Total items matching the criteria."
  }),
  hasMoreTotalItems: import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
  ...
  startCursor: import_zod.z.optional(zStartCursor),
  endCursor: import_zod.z.optional(zEndCursor)
}).register(import_zod.z.globalRegistry, {
  description: "Pagination information about the search results."
});
var zSearchQueryResponse = import_zod.z.object({
  page: zSearchQueryPageResponse
});
var zTenantSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zTenantResult).register(import_zod.z.globalRegistry, {
    description: "The matching tenants."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Tenant search response."
}));
var zUserTaskSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "creationDate",
    "completionDate",
    "followUpDate",
...
var zUserTaskStateEnum = import_zod.z.enum([
  "CREATING",
  "CREATED",
  "ASSIGNING",
  "UPDATING",
...
var zLikeFilter = import_zod.z.string().register(import_zod.z.globalRegistry, {
  description: "Checks if the property matches the provided like value.\n\nSupported wildcard characters are:\n\n* `*`: matches zero, one, or multiple characters.\n* `?`: matches one, single character.\n\nWildcard characters can be escaped with backslash, for instance: `\\*`.\n"
});
var zAdvancedUserTaskStateFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zUserTaskStateEnum),
  "$neq": import_zod.z.optional(zUserTaskStateEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zUserTaskStateEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Advanced UserTaskStateEnum filter."
});
var zUserTaskStateFilterProperty = import_zod.z.union([
  zUserTaskStateEnum,
  zAdvancedUserTaskStateFilter
]);
var zBasicStringFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "Checks for equality with the provided value."
  })),
  "$neq": import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "Checks for inequality with the provided value."
  })),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Basic advanced string filter."
});
var zAdvancedStringFilter = zBasicStringFilter.and(import_zod.z.object({
  "$like": import_zod.z.optional(zLikeFilter)
}));
var zStringFilterProperty = import_zod.z.union([
  import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "Matches the value exactly."
  }),
  zAdvancedStringFilter
]);
var zAdvancedIntegerFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "Checks for equality with the provided value."
  })),
  "$neq": import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "Checks for inequality with the provided value."
  })),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$gt": import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "Greater than comparison with the provided value."
  })),
  "$gte": import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "Greater than or equal comparison with the provided value."
  })),
  "$lt": import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "Lower than comparison with the provided value."
  })),
  "$lte": import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "Lower than or equal comparison with the provided value."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(import_zod.z.int()).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced integer (int32) filter."
});
var zIntegerFilterProperty = import_zod.z.union([
  import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "Matches the value exactly."
  }),
  zAdvancedIntegerFilter
]);
var zAdvancedDateTimeFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "Checks for equality with the provided value."
  })),
  "$neq": import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "Checks for inequality with the provided value."
  })),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$gt": import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "Greater than comparison with the provided value."
  })),
  "$gte": import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "Greater than or equal comparison with the provided value."
  })),
  "$lt": import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "Lower than comparison with the provided value."
  })),
  "$lte": import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "Lower than or equal comparison with the provided value."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(import_zod.z.iso.datetime()).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced date-time filter."
});
var zDateTimeFilterProperty = import_zod.z.union([
  import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "Matches the value exactly."
  }),
  zAdvancedDateTimeFilter
]);
var zVariableValueFilterProperty = import_zod.z.object({
  name: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "Name of the variable."
  }),
  value: zStringFilterProperty
});
var zUserTaskFilter = import_zod.z.object({
  state: import_zod.z.optional(zUserTaskStateFilterProperty),
  ...
  creationDate: import_zod.z.optional(zDateTimeFilterProperty),
  completionDate: import_zod.z.optional(zDateTimeFilterProperty),
  followUpDate: import_zod.z.optional(zDateTimeFilterProperty),
  dueDate: import_zod.z.optional(zDateTimeFilterProperty),
  processInstanceVariables: import_zod.z.optional(import_zod.z.array(zVariableValueFilterProperty).register(import_zod.z.globalRegistry, {
    description: "Process instance variables associated with the user task."
  })),
  localVariables: import_zod.z.optional(import_zod.z.array(zVariableValueFilterProperty).register(import_zod.z.globalRegistry, {
...
var zUserTaskSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zUserTaskSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zUserTaskFilter)
}).register(import_zod.z.globalRegistry, {
  description: "User task search query request."
}));
var zUserTaskVariableSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "value",
    "name",
    "tenantId",
...
var zUserTaskVariableFilter = import_zod.z.object({
  name: import_zod.z.optional(zStringFilterProperty)
}).register(import_zod.z.globalRegistry, {
  description: "The user task variable search filters."
});
var zUserTaskVariableSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
...
var zUserTaskResult = import_zod.z.object({
  ...
  state: import_zod.z.optional(zUserTaskStateEnum),
  assignee: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The assignee of the user task."
  })),
  elementId: import_zod.z.optional(zElementId),
  candidateGroups: import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "The candidate groups for this user task."
  })),
  candidateUsers: import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "The candidate users for this user task."
  })),
  processDefinitionId: import_zod.z.optional(zProcessDefinitionId),
  creationDate: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "The creation date of a user task."
  })),
  completionDate: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "The completion date of a user task."
  })),
  followUpDate: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "The follow date of a user task."
  })),
  dueDate: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "The due date of a user task."
  })),
  tenantId: import_zod.z.optional(zTenantId),
  externalFormReference: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
  ...
  customHeaders: import_zod.z.optional(import_zod.z.record(import_zod.z.string(), import_zod.z.string()).register(import_zod.z.globalRegistry, {
...
var zVariableSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "value",
    "name",
    "tenantId",
...
var zAdvancedVariableKeyFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zVariableKey),
  "$neq": import_zod.z.optional(zVariableKey),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zVariableKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(zVariableKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced VariableKey filter."
});
var zVariableKeyFilterProperty = import_zod.z.union([
  zVariableKey,
  zAdvancedVariableKeyFilter
]);
var zAdvancedScopeKeyFilter = import_zod.z.object({
...
var zScopeKeyFilterProperty = import_zod.z.union([
  zScopeKey,
  zAdvancedScopeKeyFilter
]);
var zAdvancedProcessInstanceKeyFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zProcessInstanceKey),
  "$neq": import_zod.z.optional(zProcessInstanceKey),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zProcessInstanceKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(zProcessInstanceKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced ProcessInstanceKey filter."
});
var zProcessInstanceKeyFilterProperty = import_zod.z.union([
  zProcessInstanceKey,
  zAdvancedProcessInstanceKeyFilter
]);
var zVariableFilter = import_zod.z.object({
  name: import_zod.z.optional(zStringFilterProperty),
  value: import_zod.z.optional(zStringFilterProperty),
  tenantId: import_zod.z.optional(zTenantId),
...
var zVariableSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zVariableSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zVariableFilter)
}).register(import_zod.z.globalRegistry, {
...
var zProcessDefinitionSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
...
var zProcessDefinitionFilter = import_zod.z.object({
  ...
  versionTag: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zProcessDefinitionSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zProcessDefinitionSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zProcessDefinitionFilter)
}));
var zProcessDefinitionResult = import_zod.z.object({
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zProcessDefinitionSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zProcessDefinitionResult).register(import_zod.z.globalRegistry, {
...
var zProcessInstanceStateEnum = import_zod.z.enum([
  "ACTIVE",
  "COMPLETED",
  "TERMINATED"
]).register(import_zod.z.globalRegistry, {
...
var zAdvancedProcessInstanceStateFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zProcessInstanceStateEnum),
  "$neq": import_zod.z.optional(zProcessInstanceStateEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zProcessInstanceStateEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zProcessInstanceStateFilterProperty = import_zod.z.union([
  zProcessInstanceStateEnum,
  zAdvancedProcessInstanceStateFilter
]);
var zAdvancedElementInstanceKeyFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zElementInstanceKey),
  "$neq": import_zod.z.optional(zElementInstanceKey),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zElementInstanceKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(zElementInstanceKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced ElementInstanceKey filter."
});
var zElementInstanceKeyFilterProperty = import_zod.z.union([
  zElementInstanceKey,
  zAdvancedElementInstanceKeyFilter
]);
var zElementInstanceStateEnum = import_zod.z.enum([
  "ACTIVE",
  "COMPLETED",
  "TERMINATED"
]).register(import_zod.z.globalRegistry, {
...
var zAdvancedElementInstanceStateFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zElementInstanceStateEnum),
  "$neq": import_zod.z.optional(zElementInstanceStateEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zElementInstanceStateEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zElementInstanceStateFilterProperty = import_zod.z.union([
  zElementInstanceStateEnum,
  zAdvancedElementInstanceStateFilter
]);
var zTag = import_zod.z.string().min(1).max(100).regex(/^[A-Za-z][A-Za-z0-9_\-:.]{0,99}$/).register(import_zod.z.globalRegistry, {
  description: "A tag. Needs to start with a letter; then alphanumerics, `_`, `-`, `:`, or `.`; length \u2264 100."
});
var zTagSet = import_zod.z.array(zTag).max(10).register(import_zod.z.globalRegistry, {
  description: "List of tags. Tags need to start with a letter; then alphanumerics, `_`, `-`, `:`, or `.`; length \u2264 100."
});
var zBaseProcessInstanceFilterFields = import_zod.z.object({
  startDate: import_zod.z.optional(zDateTimeFilterProperty),
  endDate: import_zod.z.optional(zDateTimeFilterProperty),
  state: import_zod.z.optional(zProcessInstanceStateFilterProperty),
  hasIncident: import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Whether this process instance has a related incident or not."
  })),
  tenantId: import_zod.z.optional(zStringFilterProperty),
  variables: import_zod.z.optional(import_zod.z.array(zVariableValueFilterProperty).register(import_zod.z.globalRegistry, {
  ...
  elementInstanceState: import_zod.z.optional(zElementInstanceStateFilterProperty),
  elementId: import_zod.z.optional(zStringFilterProperty),
  hasElementInstanceIncident: import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
...
var zAdvancedProcessDefinitionKeyFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zProcessDefinitionKey),
  "$neq": import_zod.z.optional(zProcessDefinitionKey),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zProcessDefinitionKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(zProcessDefinitionKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced ProcessDefinitionKey filter."
});
var zProcessDefinitionKeyFilterProperty = import_zod.z.union([
  zProcessDefinitionKey,
  zAdvancedProcessDefinitionKeyFilter
]);
var zProcessInstanceFilterFields = zBaseProcessInstanceFilterFields.and(import_zod.z.object({
  processDefinitionId: import_zod.z.optional(zStringFilterProperty),
  processDefinitionName: import_zod.z.optional(zStringFilterProperty),
  processDefinitionVersion: import_zod.z.optional(zIntegerFilterProperty),
  processDefinitionVersionTag: import_zod.z.optional(zStringFilterProperty),
  processDefinitionKey: import_zod.z.optional(zProcessDefinitionKeyFilterProperty)
}).register(import_zod.z.globalRegistry, {
  description: "Process instance search filter."
}));
var zProcessInstanceFilter = zProcessInstanceFilterFields.and(import_zod.z.object({
  "$or": import_zod.z.optional(import_zod.z.array(zProcessInstanceFilterFields).register(import_zod.z.globalRegistry, {
...
var zProcessInstanceSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zProcessInstanceSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zProcessInstanceFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Process instance search request."
}));
var zIncidentSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "incidentKey",
    "processDefinitionKey",
    "processDefinitionId",
...
var zProcessInstanceIncidentSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zIncidentSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zAdvancedDecisionDefinitionKeyFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zDecisionDefinitionKey),
  "$neq": import_zod.z.optional(zDecisionDefinitionKey),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zDecisionDefinitionKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(zDecisionDefinitionKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced DecisionDefinitionKey filter."
});
var zDecisionDefinitionKeyFilterProperty = import_zod.z.union([
  zDecisionDefinitionKey,
  zAdvancedDecisionDefinitionKeyFilter
]);
var zBasicStringFilterProperty = import_zod.z.union([
  import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "Matches the value exactly."
  }),
  zBasicStringFilter
...
var zAdvancedMessageSubscriptionKeyFilter = import_zod.z.object({
  ...
  "$neq": import_zod.z.optional(zMessageSubscriptionKey),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zMessageSubscriptionKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(zMessageSubscriptionKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced MessageSubscriptionKey filter."
});
var zMessageSubscriptionKeyFilterProperty = import_zod.z.union([
  zMessageSubscriptionKey,
  zAdvancedMessageSubscriptionKeyFilter
]);
var zAdvancedJobKeyFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zJobKey),
  "$neq": import_zod.z.optional(zJobKey),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zJobKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$notIn": import_zod.z.optional(import_zod.z.array(zJobKey).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches none of the provided values."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Advanced JobKey filter."
});
var zJobKeyFilterProperty = import_zod.z.union([
  zJobKey,
  zAdvancedJobKeyFilter
]);
var zProcessDefinitionStatisticsFilter = zBaseProcessInstanceFilterFields.and(import_zod.z.object({
  "$or": import_zod.z.optional(import_zod.z.array(zBaseProcessInstanceFilterFields).register(import_zod.z.globalRegistry, {
    description: 'Defines a list of alternative filter groups combined using OR logic. Each object in the array is evaluated independently, and the filter matches if any one of them is satisfied.\n\nTop-level fields and the `$or` clause are combined using AND logic \u2014 meaning: (top-level filters) AND (any of the `$or` filters) must match.\n<br>\n<em>Example:</em>\n\n```json\n{\n  "state": "ACTIVE",\n  "tenantId": 123,\n  "$or": [\n    { "processDefinitionId": "process_v1" },\n    { "processDefinitionId": "process_v2", "hasIncident": true }\n  ]\n}\n```\nThis matches process instances that:\n\n<ul style="padding-left: 20px; margin-left: 20px;">\n  <li style="list-style-type: disc;">are in <em>ACTIVE</em> state</li>\n  <li style="list-style-type: disc;">have tenant ID equal to <em>123</em></li>\n  <li style="list-style-type: disc;">and match either:\n    <ul style="padding-left: 20px; margin-left: 20px;">\n      <li style="list-style-type: circle;"><code>processDefinitionId</code> is <em>process_v1</em>, or</li>\n      <li style="list-style-type: circle;"><code>processDefinitionId</code> is <em>process_v2</em> and <code>hasIncident</code> is <em>true</em></li>\n    </ul>\n  </li>\n</ul>\n<br>\n<p>Note: Using complex <code>$or</code> conditions may impact performance, use with caution in high-volume environments.\n'
  }))
}));
var zProcessInstanceResult = import_zod.z.object({
  ...
  processDefinitionVersionTag: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zProcessInstanceSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.array(zProcessInstanceResult).register(import_zod.z.globalRegistry, {
    description: "The matching process instances."
  })
}).register(import_zod.z.globalRegistry, {
  description: "Process instance search response."
}));
var zProcessInstanceCallHierarchyEntry = import_zod.z.object({
  processInstanceKey: zProcessInstanceKey,
  processDefinitionKey: zProcessDefinitionKey,
  processDefinitionName: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zProcessInstanceSequenceFlowsQueryResult = import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zProcessInstanceSequenceFlowResult).register(import_zod.z.globalRegistry, {
    description: "The sequence flows."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Process instance sequence flows query response."
});
var zProcessDefinitionElementStatisticsQuery = import_zod.z.object({
  filter: import_zod.z.optional(zProcessDefinitionStatisticsFilter)
}).register(import_zod.z.globalRegistry, {
...
var zProcessDefinitionElementStatisticsQueryResult = import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zProcessElementStatisticsResult).register(import_zod.z.globalRegistry, {
    description: "The element statistics."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Process definition element statistics query response."
});
var zProcessInstanceElementStatisticsQueryResult = import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zProcessElementStatisticsResult).register(import_zod.z.globalRegistry, {
    description: "The element statistics."
  }))
}).register(import_zod.z.globalRegistry, {
...
var zElementInstanceSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "elementInstanceKey",
    "processInstanceKey",
    "processDefinitionKey",
...
var zElementInstanceFilter = import_zod.z.object({
  processDefinitionId: import_zod.z.optional(zProcessDefinitionId),
  state: import_zod.z.optional(zElementInstanceStateFilterProperty),
  ...
  elementId: import_zod.z.optional(zElementId),
  elementName: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
  ...
  startDate: import_zod.z.optional(zDateTimeFilterProperty),
  endDate: import_zod.z.optional(zDateTimeFilterProperty),
  elementInstanceScopeKey: import_zod.z.optional(import_zod.z.union([
    zElementInstanceKey,
    zProcessInstanceKey
  ]))
}).register(import_zod.z.globalRegistry, {
...
var zElementInstanceSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zElementInstanceSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zElementInstanceFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Element instance search request."
}));
var zElementInstanceResult = import_zod.z.object({
  processDefinitionId: zProcessDefinitionId,
  startDate: import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
...
var zElementInstanceSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zElementInstanceResult).register(import_zod.z.globalRegistry, {
    description: "The matching element instances."
  }))
}));
var zAdHocSubProcessActivateActivityReference = import_zod.z.object({
  elementId: zElementId,
...
var zAdHocSubProcessActivateActivitiesInstruction = import_zod.z.object({
  elements: import_zod.z.array(zAdHocSubProcessActivateActivityReference).register(import_zod.z.globalRegistry, {
    description: "Activities to activate."
  }),
  cancelRemainingInstances: import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Whether to cancel remaining instances of the ad-hoc sub-process."
  })).default(false)
});
var zDecisionDefinitionSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
...
var zDecisionDefinitionFilter = import_zod.z.object({
...
var zDecisionDefinitionSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zDecisionDefinitionSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zDecisionDefinitionFilter)
}));
var zIncidentFilter = import_zod.z.object({
  processDefinitionId: import_zod.z.optional(zProcessDefinitionId),
  errorType: import_zod.z.optional(import_zod.z.enum([
    "UNSPECIFIED",
    "UNKNOWN",
    "IO_MAPPING_ERROR",
    "JOB_NO_RETRIES",
  ...
  elementId: import_zod.z.optional(zElementId),
  creationTime: import_zod.z.optional(zDateTimeFilterProperty),
...
var zIncidentSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zIncidentSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zIncidentFilter)
}));
...
var zIncidentSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zIncidentResult).register(import_zod.z.globalRegistry, {
...
var zCorrelatedMessageSubscriptionSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zCorrelatedMessageSubscriptionResult).register(import_zod.z.globalRegistry, {
    description: "The matching correlated message subscriptions."
  }))
}));
var zCorrelatedMessageSubscriptionSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "correlationKey",
    "correlationTime",
    "elementId",
...
var zCorrelatedMessageSubscriptionFilter = import_zod.z.object({
  correlationKey: import_zod.z.optional(zStringFilterProperty),
  correlationTime: import_zod.z.optional(zDateTimeFilterProperty),
  elementId: import_zod.z.optional(zStringFilterProperty),
  elementInstanceKey: import_zod.z.optional(zElementInstanceKeyFilterProperty),
  messageKey: import_zod.z.optional(zBasicStringFilterProperty),
  messageName: import_zod.z.optional(zStringFilterProperty),
  partitionId: import_zod.z.optional(zIntegerFilterProperty),
  processDefinitionId: import_zod.z.optional(zStringFilterProperty),
  processDefinitionKey: import_zod.z.optional(zBasicStringFilterProperty),
  processInstanceKey: import_zod.z.optional(zBasicStringFilterProperty),
  subscriptionKey: import_zod.z.optional(zBasicStringFilterProperty),
  tenantId: import_zod.z.optional(zStringFilterProperty)
}).register(import_zod.z.globalRegistry, {
  description: "Correlated message subscriptions search filter."
});
var zCorrelatedMessageSubscriptionSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zCorrelatedMessageSubscriptionSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zCorrelatedMessageSubscriptionFilter)
}));
var zMessageSubscriptionStateEnum = import_zod.z.enum([
  "CORRELATED",
  "CREATED",
  "DELETED",
  "MIGRATED"
...
var zMessageSubscriptionSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zMessageSubscriptionResult).register(import_zod.z.globalRegistry, {
    description: "The matching message subscriptions."
  }))
}));
var zMessageSubscriptionSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
...
var zAdvancedMessageSubscriptionStateFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zMessageSubscriptionStateEnum),
  "$neq": import_zod.z.optional(zMessageSubscriptionStateEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zMessageSubscriptionStateEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zMessageSubscriptionStateFilterProperty = import_zod.z.union([
  zMessageSubscriptionStateEnum,
  zAdvancedMessageSubscriptionStateFilter
]);
var zMessageSubscriptionFilter = import_zod.z.object({
  messageSubscriptionKey: import_zod.z.optional(zMessageSubscriptionKeyFilterProperty),
  processDefinitionId: import_zod.z.optional(zStringFilterProperty),
  processInstanceKey: import_zod.z.optional(zProcessInstanceKeyFilterProperty),
  elementId: import_zod.z.optional(zStringFilterProperty),
  elementInstanceKey: import_zod.z.optional(zElementInstanceKeyFilterProperty),
  messageSubscriptionState: import_zod.z.optional(zMessageSubscriptionStateFilterProperty),
  lastUpdatedDate: import_zod.z.optional(zDateTimeFilterProperty),
  messageName: import_zod.z.optional(zStringFilterProperty),
  correlationKey: import_zod.z.optional(zStringFilterProperty),
  tenantId: import_zod.z.optional(zStringFilterProperty)
}).register(import_zod.z.globalRegistry, {
...
var zMessageSubscriptionSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zMessageSubscriptionSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zMessageSubscriptionFilter)
}));
var zDecisionDefinitionResult = import_zod.z.object({
  decisionDefinitionId: import_zod.z.optional(zDecisionDefinitionId),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The DMN name of the decision definition."
  })),
...
var zDecisionDefinitionSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zDecisionDefinitionResult).register(import_zod.z.globalRegistry, {
    description: "The matching decision definitions."
  }))
}));
var zUsageMetricsResponseItem = import_zod.z.object({
  processInstances: import_zod.z.optional(import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
    description: "The amount of created root process instances."
  })),
  decisionInstances: import_zod.z.optional(import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
    description: "The amount of executed decision instances."
  })),
  assignees: import_zod.z.optional(import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
    description: "The amount of unique active task users."
  }))
});
var zUsageMetricsResponse = zUsageMetricsResponseItem.and(import_zod.z.object({
  activeTenants: import_zod.z.optional(import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
    description: "The amount of active tenants."
  })),
  tenants: import_zod.z.optional(import_zod.z.record(import_zod.z.string(), zUsageMetricsResponseItem).register(import_zod.z.globalRegistry, {
    description: "The usage metrics by tenants. Only available if request `withTenants` query parameter was `true`."
  }))
}));
var zPermissionTypeEnum = import_zod.z.enum([
  "ACCESS",
  "CREATE",
...
var zResourceTypeEnum = import_zod.z.enum([
  "AUTHORIZATION",
  "MAPPING_RULE",
  "MESSAGE",
  "BATCH",
...
var zOwnerTypeEnum = import_zod.z.enum([
  "USER",
  "CLIENT",
  "ROLE",
  "GROUP",
...
var zAuthorizationRequest = import_zod.z.object({
  ownerId: import_zod.z.string().register(import_zod.z.globalRegistry, {
  ...
  permissionTypes: import_zod.z.array(zPermissionTypeEnum).register(import_zod.z.globalRegistry, {
    description: "The permission types to add."
  })
});
var zAuthorizationCreateResult = import_zod.z.object({
  authorizationKey: import_zod.z.optional(zAuthorizationKey)
});
var zAuthorizationSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "ownerId",
    "ownerType",
    "resourceId",
...
var zAuthorizationFilter = import_zod.z.object({
  ownerId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The ID of the owner of permissions."
  })),
  ownerType: import_zod.z.optional(zOwnerTypeEnum),
  resourceIds: import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "The IDs of the resource to search permissions for."
  })),
  resourceType: import_zod.z.optional(zResourceTypeEnum)
}).register(import_zod.z.globalRegistry, {
  description: "Authorization search filter."
});
var zAuthorizationSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zAuthorizationSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zAuthorizationFilter)
}));
var zAuthorizationResult = import_zod.z.object({
  ownerId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The ID of the owner of permissions."
  })),
  ownerType: import_zod.z.optional(zOwnerTypeEnum),
  ...
  permissionTypes: import_zod.z.optional(import_zod.z.array(zPermissionTypeEnum).register(import_zod.z.globalRegistry, {
    description: "Specifies the types of the permissions."
  })),
  authorizationKey: import_zod.z.optional(zAuthorizationKey)
});
var zAuthorizationSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zAuthorizationResult).register(import_zod.z.globalRegistry, {
    description: "The matching authorizations."
  }))
}));
var zUserRequest = import_zod.z.object({
  password: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The password of the user."
  }),
  username: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The username of the user."
  }),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the user."
  })),
  email: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The email of the user."
  }))
});
var zUsername = import_zod.z.string().min(1).max(256).regex(/^(<default>|[A-Za-z0-9_@.+-]+)$/).register(import_zod.z.globalRegistry, {
  description: "The unique name of a user."
});
var zUserCreateResult = import_zod.z.object({
  username: import_zod.z.optional(zUsername),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the user."
  })),
  email: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zUserUpdateResult = import_zod.z.object({
  username: import_zod.z.optional(zUsername),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the user."
  })),
...
var zUserSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "username",
    "name",
    "email"
...
var zUserFilter = import_zod.z.object({
  username: import_zod.z.optional(zStringFilterProperty),
  name: import_zod.z.optional(zStringFilterProperty),
  email: import_zod.z.optional(zStringFilterProperty)
}).register(import_zod.z.globalRegistry, {
  description: "User search filter."
});
var zUserSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zUserSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zUserFilter)
}));
var zMappingRuleSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "mappingRuleId",
    "claimName",
    "claimValue",
...
var zMappingRuleFilter = import_zod.z.object({
  claimName: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The claim name to match against a token."
  })),
  claimValue: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The value of the claim to match."
  })),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the mapping rule."
  })),
  mappingRuleId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The ID of the mapping rule."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Mapping rule search filter."
});
var zMappingRuleSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zMappingRuleSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zMappingRuleFilter)
}));
var zCamundaUserResult = import_zod.z.object({
  ...
  authorizedComponents: import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "The web components the user is authorized to use."
  })),
  tenants: import_zod.z.array(zTenantResult).register(import_zod.z.globalRegistry, {
    description: "The tenants the user is a member of."
  }),
  groups: import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "The groups assigned to the user."
  }),
  roles: import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "The roles assigned to the user."
  }),
  salesPlanType: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The plan of the user."
  }),
  c8Links: import_zod.z.record(import_zod.z.string(), import_zod.z.string()).register(import_zod.z.globalRegistry, {
    description: "The links to the components in the C8 stack."
  }),
  canLogout: import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Flag for understanding if the user is able to perform logout."
  })
});
var zUserResult = import_zod.z.object({
  username: import_zod.z.optional(zUsername),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the user."
  })),
...
var zUserSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.array(zUserResult).register(import_zod.z.globalRegistry, {
    description: "The matching users."
  })
}));
var zUserUpdateRequest = import_zod.z.object({
  password: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zTenantClientResult = import_zod.z.object({
  clientId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The ID of the client."
  }))
});
var zTenantClientSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zTenantClientResult).register(import_zod.z.globalRegistry, {
    description: "The matching clients."
  }))
}));
var zTenantClientSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "clientId"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zTenantClientSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zTenantClientSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zTenantUserResult = import_zod.z.object({
  username: import_zod.z.optional(zUsername)
});
var zTenantUserSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zTenantUserResult).register(import_zod.z.globalRegistry, {
    description: "The matching users."
  }))
}));
var zTenantUserSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "username"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zTenantUserSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zTenantUserSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zTenantGroupResult = import_zod.z.object({
...
var zTenantGroupSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zTenantGroupResult).register(import_zod.z.globalRegistry, {
    description: "The matching groups."
  }))
}));
var zTenantGroupSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "groupId"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zTenantGroupSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zTenantGroupSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zRoleCreateRequest = import_zod.z.object({
  roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zRoleCreateResult = import_zod.z.object({
  roleId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zRoleUpdateRequest = import_zod.z.object({
  name: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The display name of the new role."
  }),
  description: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zRoleResult = import_zod.z.object({
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zRoleSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "name",
    "roleId"
  ]).register(import_zod.z.globalRegistry, {
...
var zRoleFilter = import_zod.z.object({
  roleId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zRoleSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zRoleSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zRoleFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Role search request."
}));
var zRoleSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zRoleResult).register(import_zod.z.globalRegistry, {
    description: "The matching roles."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Role search response."
}));
var zRoleUserResult = import_zod.z.object({
  username: import_zod.z.optional(zUsername)
});
var zRoleUserSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zRoleUserResult).register(import_zod.z.globalRegistry, {
    description: "The matching users."
  }))
}));
var zRoleUserSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "username"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zRoleUserSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zRoleUserSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zRoleClientResult = import_zod.z.object({
  clientId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The ID of the client."
  }))
});
var zRoleClientSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zRoleClientResult).register(import_zod.z.globalRegistry, {
    description: "The matching clients."
  }))
}));
var zRoleClientSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "clientId"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zRoleClientSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zRoleClientSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zRoleGroupResult = import_zod.z.object({
  groupId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The id of the group."
  }))
});
var zRoleGroupSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zRoleGroupResult).register(import_zod.z.globalRegistry, {
    description: "The matching groups."
  }))
}));
var zRoleGroupSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "groupId"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zRoleGroupSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zRoleGroupSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zGroupCreateRequest = import_zod.z.object({
  groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zGroupCreateResult = import_zod.z.object({
  groupId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zGroupUpdateRequest = import_zod.z.object({
  name: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zGroupResult = import_zod.z.object({
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zGroupSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "name",
    "groupId"
  ]).register(import_zod.z.globalRegistry, {
...
var zGroupFilter = import_zod.z.object({
  groupId: import_zod.z.optional(zStringFilterProperty),
  name: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zGroupSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zGroupSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zGroupFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Group search request."
}));
var zGroupSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zGroupResult).register(import_zod.z.globalRegistry, {
    description: "The matching groups."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Group search response."
}));
var zGroupUserResult = import_zod.z.object({
  username: import_zod.z.optional(zUsername)
});
var zGroupUserSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zGroupUserResult).register(import_zod.z.globalRegistry, {
    description: "The matching members."
  }))
}));
var zGroupUserSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "username"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zGroupUserSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zGroupUserSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zGroupClientResult = import_zod.z.object({
  clientId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The ID of the client."
  }))
});
var zGroupClientSearchResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zGroupClientResult).register(import_zod.z.globalRegistry, {
    description: "The matching client IDs."
  }))
}));
var zGroupClientSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "clientId"
  ]).register(import_zod.z.globalRegistry, {
    description: "The field to sort by."
...
var zGroupClientSearchQueryRequest = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zGroupClientSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  }))
}));
var zMappingRuleCreateUpdateRequest = import_zod.z.object({
  claimName: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the claim to map."
  }),
  claimValue: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zMappingRuleCreateRequest = zMappingRuleCreateUpdateRequest.and(import_zod.z.object({
  mappingRuleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The unique ID of the mapping rule."
  })
}));
var zMappingRuleUpdateRequest = zMappingRuleCreateUpdateRequest;
var zMappingRuleCreateUpdateResult = import_zod.z.object({
  claimName: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the claim to map."
  })),
  claimValue: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zMappingRuleResult = import_zod.z.object({
  claimName: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the claim to map."
  })),
  claimValue: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zMappingRuleSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zMappingRuleResult).register(import_zod.z.globalRegistry, {
    description: "The matching mapping rules."
  }))
}));
var zPartition = import_zod.z.object({
  partitionId: import_zod.z.int().register(import_zod.z.globalRegistry, {
...
var zBrokerInfo = import_zod.z.object({
  nodeId: import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "The unique (within a cluster) node ID for the broker."
  }),
  host: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The hostname for reaching the broker."
  }),
  port: import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "The port for reaching the broker."
  }),
  partitions: import_zod.z.array(zPartition).register(import_zod.z.globalRegistry, {
    description: "A list of partitions managed or replicated on this broker."
  }),
  version: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The broker version."
  })
}).register(import_zod.z.globalRegistry, {
  description: "Provides information on a broker node."
});
var zTopologyResponse = import_zod.z.object({
  ...
  partitionsCount: import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "The number of partitions are spread across the cluster."
  }),
  replicationFactor: import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "The configured replication factor for this cluster."
  }),
  gatewayVersion: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The version of the Zeebe Gateway."
  }),
  lastCompletedChangeId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zLicenseResponse = import_zod.z.object({
  ...
  licenseType: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "Will return the license type property of the Camunda license"
  }),
  isCommercial: import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Will be false when a license contains a non-commerical=true property"
  }),
  expiresAt: import_zod.z.optional(import_zod.z.union([
...
var zChangeset = import_zod.z.union([
  import_zod.z.object({
    ...
    candidateUsers: import_zod.z.optional(import_zod.z.union([
      import_zod.z.array(import_zod.z.string()),
      import_zod.z.null()
    ])),
    candidateGroups: import_zod.z.optional(import_zod.z.union([
      import_zod.z.array(import_zod.z.string()),
      import_zod.z.null()
    ])),
    priority: import_zod.z.optional(import_zod.z.union([
      import_zod.z.int().gte(0).lte(100).default(50),
      import_zod.z.null()
    ])).default(50)
  }),
  import_zod.z.null()
]);
var zUserTaskUpdateRequest = import_zod.z.object({
  changeset: import_zod.z.optional(zChangeset),
  action: import_zod.z.optional(import_zod.z.union([
    import_zod.z.string(),
    import_zod.z.null()
  ]))
...
var zJobKindEnum = import_zod.z.enum([
  "BPMN_ELEMENT",
  "EXECUTION_LISTENER",
  "TASK_LISTENER",
  "AD_HOC_SUB_PROCESS"
...
var zJobListenerEventTypeEnum = import_zod.z.enum([
  "ASSIGNING",
  "CANCELING",
  "COMPLETING",
  "CREATING",
...
var zUserTaskProperties = import_zod.z.object({
  ...
  changedAttributes: import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
...
var zActivatedJobResult = import_zod.z.object({
  type: import_zod.z.string().register(import_zod.z.globalRegistry, {
  ...
  elementId: zElementId,
  customHeaders: import_zod.z.record(import_zod.z.string(), import_zod.z.unknown()).register(import_zod.z.globalRegistry, {
  ...
  deadline: import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
    description: "When the job can be activated again, sent as a UNIX epoch timestamp."
  }),
  variables: import_zod.z.record(import_zod.z.string(), import_zod.z.unknown()).register(import_zod.z.globalRegistry, {
  ...
  userTask: import_zod.z.optional(zUserTaskProperties),
  tags: import_zod.z.optional(zTagSet)
});
var zJobActivationResult = import_zod.z.object({
  jobs: import_zod.z.array(zActivatedJobResult).register(import_zod.z.globalRegistry, {
...
var zJobFailRequest = import_zod.z.object({
  ...
  retryBackOff: import_zod.z.optional(import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
...
var zJobErrorRequest = import_zod.z.object({
...
var zJobResultCorrections = import_zod.z.union([
  import_zod.z.object({
    assignee: import_zod.z.optional(import_zod.z.union([
      import_zod.z.string(),
      import_zod.z.null()
...
var zJobResultUserTask = import_zod.z.union([
  import_zod.z.object({
    denied: import_zod.z.optional(import_zod.z.union([
      import_zod.z.boolean(),
      import_zod.z.null()
    ])),
    ...
    corrections: import_zod.z.optional(zJobResultCorrections)
  }),
  import_zod.z.null()
]);
var zJobResultActivateElement = import_zod.z.object({
  elementId: import_zod.z.optional(zElementId),
  variables: import_zod.z.optional(import_zod.z.union([
    import_zod.z.record(import_zod.z.string(), import_zod.z.unknown()),
    import_zod.z.null()
...
var zJobResultAdHocSubProcess = import_zod.z.union([
  import_zod.z.object({
    activateElements: import_zod.z.optional(import_zod.z.array(zJobResultActivateElement).register(import_zod.z.globalRegistry, {
...
var zJobResult = import_zod.z.intersection(import_zod.z.union([
  import_zod.z.object({
    type: import_zod.z.literal("userTask")
  }).and(zJobResultUserTask),
  import_zod.z.object({
    type: import_zod.z.literal("adHocSubProcess")
...
var zJobCompletionRequest = import_zod.z.object({
  variables: import_zod.z.optional(import_zod.z.union([
    import_zod.z.record(import_zod.z.string(), import_zod.z.unknown()),
    import_zod.z.null()
  ])),
  result: import_zod.z.optional(zJobResult)
});
var zJobChangeset = import_zod.z.object({
  retries: import_zod.z.optional(import_zod.z.union([
    import_zod.z.int(),
    import_zod.z.null()
  ])),
  timeout: import_zod.z.optional(import_zod.z.union([
    import_zod.z.coerce.bigint(),
    import_zod.z.null()
  ]))
}).register(import_zod.z.globalRegistry, {
...
var zJobUpdateRequest = import_zod.z.object({
  changeset: zJobChangeset,
  operationReference: import_zod.z.optional(zOperationReference)
});
var zJobSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "deadline",
    "deniedReason",
    "elementId",
...
var zAdvancedJobKindFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zJobKindEnum),
  "$neq": import_zod.z.optional(zJobKindEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zJobKindEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zJobKindFilterProperty = import_zod.z.union([
  zJobKindEnum,
  zAdvancedJobKindFilter
]);
var zAdvancedJobListenerEventTypeFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zJobListenerEventTypeEnum),
  "$neq": import_zod.z.optional(zJobListenerEventTypeEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zJobListenerEventTypeEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zJobListenerEventTypeFilterProperty = import_zod.z.union([
...
var zAdvancedJobStateFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zJobStateEnum),
  "$neq": import_zod.z.optional(zJobStateEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zJobStateEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zJobStateFilterProperty = import_zod.z.union([
  zJobStateEnum,
  zAdvancedJobStateFilter
]);
var zJobFilter = import_zod.z.object({
  deadline: import_zod.z.optional(import_zod.z.union([
    zDateTimeFilterProperty,
    import_zod.z.null()
  ])),
  deniedReason: import_zod.z.optional(zStringFilterProperty),
  elementId: import_zod.z.optional(zStringFilterProperty),
  elementInstanceKey: import_zod.z.optional(zElementInstanceKeyFilterProperty),
  endTime: import_zod.z.optional(zDateTimeFilterProperty),
  errorCode: import_zod.z.optional(zStringFilterProperty),
  errorMessage: import_zod.z.optional(zStringFilterProperty),
  hasFailedWithRetriesLeft: import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
  ...
  kind: import_zod.z.optional(zJobKindFilterProperty),
  listenerEventType: import_zod.z.optional(zJobListenerEventTypeFilterProperty),
  processDefinitionId: import_zod.z.optional(zStringFilterProperty),
  processDefinitionKey: import_zod.z.optional(zProcessDefinitionKeyFilterProperty),
  processInstanceKey: import_zod.z.optional(zProcessInstanceKeyFilterProperty),
  retries: import_zod.z.optional(zIntegerFilterProperty),
  state: import_zod.z.optional(zJobStateFilterProperty),
  tenantId: import_zod.z.optional(zStringFilterProperty),
  type: import_zod.z.optional(zStringFilterProperty),
  worker: import_zod.z.optional(zStringFilterProperty)
}).register(import_zod.z.globalRegistry, {
  description: "Job search filter."
});
var zJobSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zJobSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zJobFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Job search request."
}));
var zJobSearchResult = import_zod.z.object({
  ...
  elementId: zElementId,
  elementInstanceKey: zElementInstanceKey,
  endTime: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
...
var zProblemDetail = import_zod.z.object({
  type: import_zod.z.optional(import_zod.z.url().register(import_zod.z.globalRegistry, {
  ...
  status: import_zod.z.optional(import_zod.z.int().gte(400).lte(600).register(import_zod.z.globalRegistry, {
  ...
  instance: import_zod.z.optional(import_zod.z.url().register(import_zod.z.globalRegistry, {
...
var zDecisionRequirementsSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "decisionRequirementsKey",
...
var zDecisionRequirementsFilter = import_zod.z.object({
...
var zDecisionRequirementsSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zDecisionRequirementsSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zDecisionRequirementsFilter)
}));
var zDecisionRequirementsResult = import_zod.z.object({
  decisionRequirementsName: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The DMN name of the decision requirements."
  })),
  version: import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
...
var zDecisionRequirementsSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zDecisionRequirementsResult).register(import_zod.z.globalRegistry, {
    description: "The matching decision requirements."
  }))
}));
var zDecisionEvaluationById = import_zod.z.object({
...
var zDecisionEvaluationInstruction = import_zod.z.union([
...
var zMatchedDecisionRuleItem = import_zod.z.object({
  ...
  evaluatedOutputs: import_zod.z.optional(import_zod.z.array(zEvaluatedDecisionOutputItem).register(import_zod.z.globalRegistry, {
    description: "The evaluated decision outputs."
  }))
}).register(import_zod.z.globalRegistry, {
...
var zEvaluatedDecisionResult = import_zod.z.object({
  ...
  decisionDefinitionType: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zEvaluateDecisionResult = import_zod.z.object({
  decisionDefinitionId: zDecisionDefinitionId,
  ...
  failureMessage: import_zod.z.string().register(import_zod.z.globalRegistry, {
  ...
  decisionInstanceKey: import_zod.z.optional(zDecisionInstanceKey),
  decisionEvaluationKey: zDecisionEvaluationKey,
  evaluatedDecisions: import_zod.z.array(zEvaluatedDecisionResult).register(import_zod.z.globalRegistry, {
    description: "Decisions that were evaluated within the requested decision evaluation."
  })
});
var zDecisionInstanceSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "decisionDefinitionId",
    "decisionDefinitionKey",
...
var zDecisionInstanceStateEnum = import_zod.z.enum([
  "EVALUATED",
  "FAILED",
  "UNSPECIFIED",
  "UNKNOWN"
...
var zDecisionDefinitionTypeEnum = import_zod.z.enum([
  "DECISION_TABLE",
  "LITERAL_EXPRESSION",
  "UNSPECIFIED",
  "UNKNOWN"
...
var zDecisionInstanceSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  ...
  filter: import_zod.z.optional(zDecisionInstanceFilter)
}));
var zDecisionInstanceResult = import_zod.z.object({
  decisionEvaluationInstanceKey: import_zod.z.optional(zDecisionEvaluationInstanceKey),
  state: import_zod.z.optional(zDecisionInstanceStateEnum),
...
var zDecisionInstanceSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zDecisionInstanceResult).register(import_zod.z.globalRegistry, {
    description: "The matching decision instances."
  }))
}));
var zDecisionInstanceGetQueryResult = zDecisionInstanceResult.and(import_zod.z.object({
  evaluatedInputs: import_zod.z.optional(import_zod.z.array(zEvaluatedDecisionInputItem).register(import_zod.z.globalRegistry, {
...
var zMessageCorrelationRequest = import_zod.z.object({
  name: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zMessageCorrelationResult = import_zod.z.object({
  tenantId: import_zod.z.optional(zTenantId),
  messageKey: import_zod.z.optional(zMessageKey),
  processInstanceKey: import_zod.z.optional(zProcessInstanceKey)
}).register(import_zod.z.globalRegistry, {
  description: "The message key of the correlated message, as well as the first process instance key it\ncorrelated with.\n"
});
var zMessagePublicationRequest = import_zod.z.object({
  name: import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the message."
  }),
  correlationKey: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
  ...
  messageId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zMessagePublicationResult = import_zod.z.object({
  tenantId: import_zod.z.optional(zTenantId),
  messageKey: import_zod.z.optional(zMessageKey)
}).register(import_zod.z.globalRegistry, {
  description: "The message key of the published message."
});
var zDocumentId = import_zod.z.string().register(import_zod.z.globalRegistry, {
  description: "Document Id that uniquely identifies a document."
});
var zDocumentMetadata = import_zod.z.object({
  contentType: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The content type of the document."
  })),
  fileName: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The name of the file."
  })),
  expiresAt: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "The date and time when the document expires."
  })),
  size: import_zod.z.optional(import_zod.z.coerce.bigint().register(import_zod.z.globalRegistry, {
    description: "The size of the document in bytes."
  })),
  processDefinitionId: import_zod.z.optional(zProcessDefinitionId),
  processInstanceKey: import_zod.z.optional(zProcessInstanceKey),
  customProperties: import_zod.z.optional(import_zod.z.record(import_zod.z.string(), import_zod.z.unknown()).register(import_zod.z.globalRegistry, {
    description: "Custom properties of the document."
  }))
}).register(import_zod.z.globalRegistry, {
  description: "Information about the document."
});
var zDocumentReference = import_zod.z.object({
  "camunda.document.type": import_zod.z.optional(import_zod.z.enum([
    "camunda"
  ]).register(import_zod.z.globalRegistry, {
    description: 'Document discriminator. Always set to "camunda".'
  })),
  storeId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The ID of the document store."
  })),
  documentId: import_zod.z.optional(zDocumentId),
  contentHash: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The hash of the document."
  })),
  metadata: import_zod.z.optional(zDocumentMetadata)
});
...
var zDocumentCreationBatchResponse = import_zod.z.object({
  createdDocuments: import_zod.z.optional(import_zod.z.array(zDocumentReference).register(import_zod.z.globalRegistry, {
    description: "Documents that were successfully created."
  })),
  failedDocuments: import_zod.z.optional(import_zod.z.array(zDocumentCreationFailureDetail).register(import_zod.z.globalRegistry, {
...
var zDocumentLink = import_zod.z.object({
  url: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zDeploymentProcessResult = import_zod.z.object({
  processDefinitionId: zProcessDefinitionId,
  processDefinitionVersion: import_zod.z.int().register(import_zod.z.globalRegistry, {
...
var zDeploymentMetadataResult = import_zod.z.object({
  processDefinition: import_zod.z.optional(zDeploymentProcessResult),
  decisionDefinition: import_zod.z.optional(zDeploymentDecisionResult),
  decisionRequirements: import_zod.z.optional(zDeploymentDecisionRequirementsResult),
  form: import_zod.z.optional(zDeploymentFormResult),
  resource: import_zod.z.optional(zDeploymentResourceResult)
});
var zDeploymentResult = import_zod.z.object({
  tenantId: zTenantId,
  deploymentKey: zDeploymentKey,
  deployments: import_zod.z.array(zDeploymentMetadataResult).register(import_zod.z.globalRegistry, {
    description: "Items deployed by the request."
  })
});
var zIncidentResolutionRequest = import_zod.z.object({
  operationReference: import_zod.z.optional(zOperationReference)
});
var zProcessInstanceCreationStartInstruction = import_zod.z.object({
  elementId: zElementId
});
var zProcessInstanceCreationTerminateInstruction = import_zod.z.object({
...
var zProcessInstanceCreationRuntimeInstruction = import_zod.z.object({
  type: import_zod.z.literal("TERMINATE_PROCESS_INSTANCE")
}).and(zProcessInstanceCreationTerminateInstruction).and(import_zod.z.object({
  type: import_zod.z.enum([
...
var zProcessInstanceCreationInstructionById = import_zod.z.object({
  processDefinitionId: zProcessDefinitionId,
  processDefinitionVersion: import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
  ...
  fetchVariables: import_zod.z.optional(import_zod.z.array(import_zod.z.string()).register(import_zod.z.globalRegistry, {
...
var zProcessInstanceCreationInstruction = import_zod.z.union([
  zProcessInstanceCreationInstructionById,
  zProcessInstanceCreationInstructionByKey
]);
var zCreateProcessInstanceResult = import_zod.z.object({
  processDefinitionId: zProcessDefinitionId,
  processDefinitionVersion: import_zod.z.int().register(import_zod.z.globalRegistry, {
...
var zMigrateProcessInstanceMappingInstruction = import_zod.z.object({
...
var zProcessInstanceMigrationBatchOperationPlan = import_zod.z.object({
...
var zProcessInstanceMigrationBatchOperationRequest = import_zod.z.object({
  filter: zProcessInstanceFilter,
  migrationPlan: zProcessInstanceMigrationBatchOperationPlan
});
var zProcessInstanceMigrationInstruction = import_zod.z.object({
  mappingInstructions: import_zod.z.array(zMigrateProcessInstanceMappingInstruction).register(import_zod.z.globalRegistry, {
    description: "Element mappings from the source process instance to the target process instance."
  }),
  operationReference: import_zod.z.optional(zOperationReference),
...
var zModifyProcessInstanceVariableInstruction = import_zod.z.object({
  variables: import_zod.z.record(import_zod.z.string(), import_zod.z.unknown()).register(import_zod.z.globalRegistry, {
  ...
  scopeId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zProcessInstanceModificationActivateInstruction = import_zod.z.object({
  elementId: zElementId,
...
var zProcessInstanceModificationTerminateInstruction = import_zod.z.object({
  elementInstanceKey: zElementInstanceKey
}).register(import_zod.z.globalRegistry, {
  description: "Instructions describing which elements should be terminated."
});
var zProcessInstanceModificationInstruction = import_zod.z.object({
  operationReference: import_zod.z.optional(zOperationReference),
...
var zSetVariableRequest = import_zod.z.object({
  variables: import_zod.z.record(import_zod.z.string(), import_zod.z.unknown()).register(import_zod.z.globalRegistry, {
    description: "JSON object representing the variables to set in the element\u2019s scope."
  }),
  local: import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
...
var zSignalBroadcastRequest = import_zod.z.object({
  signalName: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zSignalBroadcastResult = import_zod.z.object({
  tenantId: zTenantId,
...
var zResourceResult = import_zod.z.object({
  resourceName: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
    description: "The resource name from which this resource was parsed."
  })),
  version: import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
...
var zBatchOperationTypeEnum = import_zod.z.enum([
  "CANCEL_PROCESS_INSTANCE",
  "RESOLVE_INCIDENT",
...
var zBatchOperationCreatedResult = import_zod.z.object({
  batchOperationKey: import_zod.z.optional(zBatchOperationKey),
  batchOperationType: import_zod.z.optional(zBatchOperationTypeEnum)
}).register(import_zod.z.globalRegistry, {
  description: "The created batch operation."
});
var zBatchOperationSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "batchOperationKey",
    "operationType",
    "state",
...
var zAdvancedBatchOperationTypeFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zBatchOperationTypeEnum),
  "$neq": import_zod.z.optional(zBatchOperationTypeEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zBatchOperationTypeEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zBatchOperationTypeFilterProperty = import_zod.z.union([
  zBatchOperationTypeEnum,
  zAdvancedBatchOperationTypeFilter
]);
var zBatchOperationStateEnum = import_zod.z.enum([
  "ACTIVE",
  "CANCELED",
  "COMPLETED",
  "CREATED",
...
var zAdvancedBatchOperationStateFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zBatchOperationStateEnum),
  "$neq": import_zod.z.optional(zBatchOperationStateEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zBatchOperationStateEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zBatchOperationStateFilterProperty = import_zod.z.union([
  zBatchOperationStateEnum,
  zAdvancedBatchOperationStateFilter
]);
var zBatchOperationFilter = import_zod.z.object({
...
var zBatchOperationSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  sort: import_zod.z.optional(import_zod.z.array(zBatchOperationSearchQuerySortRequest).register(import_zod.z.globalRegistry, {
    description: "Sort field criteria."
  })),
  filter: import_zod.z.optional(zBatchOperationFilter)
}).register(import_zod.z.globalRegistry, {
  description: "Batch operation search request."
}));
var zBatchOperationItemSearchQuerySortRequest = import_zod.z.object({
  field: import_zod.z.enum([
    "batchOperationKey",
    "itemKey",
    "processInstanceKey",
...
var zAdvancedBatchOperationItemStateFilter = import_zod.z.object({
  "$eq": import_zod.z.optional(zBatchOperationItemStateEnum),
  "$neq": import_zod.z.optional(zBatchOperationItemStateEnum),
  "$exists": import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
    description: "Checks if the current property exists."
  })),
  "$in": import_zod.z.optional(import_zod.z.array(zBatchOperationItemStateEnum).register(import_zod.z.globalRegistry, {
    description: "Checks if the property matches any of the provided values."
  })),
  "$like": import_zod.z.optional(zLikeFilter)
}).register(import_zod.z.globalRegistry, {
...
var zBatchOperationItemStateFilterProperty = import_zod.z.union([
  zBatchOperationItemStateEnum,
  zAdvancedBatchOperationItemStateFilter
]);
var zBatchOperationItemFilter = import_zod.z.object({
  batchOperationKey: import_zod.z.optional(zBasicStringFilterProperty),
...
var zBatchOperationItemSearchQuery = zSearchQueryRequest.and(import_zod.z.object({
  ...
  filter: import_zod.z.optional(zBatchOperationItemFilter)
}).register(import_zod.z.globalRegistry, {
...
var zBatchOperationResponse = import_zod.z.object({
  batchOperationKey: import_zod.z.optional(zBatchOperationKey),
  state: import_zod.z.optional(import_zod.z.enum([
    "ACTIVE",
    "CANCELED",
  ...
  batchOperationType: import_zod.z.optional(zBatchOperationTypeEnum),
  startDate: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "The start date of the batch operation."
  })),
  endDate: import_zod.z.optional(import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
    description: "The end date of the batch operation."
  })),
  operationsTotalCount: import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "The total number of items contained in this batch operation."
  })),
  operationsFailedCount: import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
  ...
  operationsCompletedCount: import_zod.z.optional(import_zod.z.int().register(import_zod.z.globalRegistry, {
    description: "The number of successfully completed tasks."
  })),
  errors: import_zod.z.optional(import_zod.z.array(zBatchOperationError).register(import_zod.z.globalRegistry, {
    description: "The errors that occurred per partition during the batch operation."
  }))
});
var zBatchOperationSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zBatchOperationResponse).register(import_zod.z.globalRegistry, {
...
var zBatchOperationItemSearchQueryResult = zSearchQueryResponse.and(import_zod.z.object({
  items: import_zod.z.optional(import_zod.z.array(zBatchOperationItemResponse).register(import_zod.z.globalRegistry, {
    description: "The matching batch operations."
  }))
}));
var zProcessInstanceCancellationBatchOperationRequest = import_zod.z.object({
  filter: zProcessInstanceFilter
}).register(import_zod.z.globalRegistry, {
  description: "The process instance filter that defines which process instances should be canceled."
});
var zProcessInstanceIncidentResolutionBatchOperationRequest = import_zod.z.object({
  filter: zProcessInstanceFilter
}).register(import_zod.z.globalRegistry, {
  description: "The process instance filter that defines which process instances should have their incidents resolved."
});
var zProcessInstanceModificationMoveBatchOperationInstruction = import_zod.z.object({
  sourceElementId: zElementId,
  targetElementId: zElementId
}).register(import_zod.z.globalRegistry, {
...
var zProcessInstanceModificationBatchOperationRequest = import_zod.z.object({
  filter: zProcessInstanceFilter,
...
var zGetTopologyData = import_zod.z.object({
...
var zGetStatusData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zGetStatusResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
...
var zGetAuthenticationData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zGetAuthenticationResponse = zCamundaUserResult;
var zActivateJobsData = import_zod.z.object({
  body: zJobActivationRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zActivateJobsResponse = zJobActivationResult;
var zSearchJobsData = import_zod.z.object({
  body: import_zod.z.optional(zJobSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchJobsResponse = zJobSearchQueryResult;
var zFailJobData = import_zod.z.object({
  body: import_zod.z.optional(zJobFailRequest),
...
var zThrowJobErrorData = import_zod.z.object({
...
var zThrowJobErrorResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
...
var zCompleteJobResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The job was completed successfully."
});
var zUpdateJobData = import_zod.z.object({
...
var zUpdateJobResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
...
var zResolveIncidentResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
...
var zDeleteTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId
  }),
...
var zDeleteTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The tenant was deleted successfully."
});
var zGetTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId
  }),
...
var zUpdateTenantData = import_zod.z.object({
...
var zUnassignUserFromTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    username: zUsername
...
var zUnassignUserFromTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user was successfully unassigned from the tenant."
});
var zAssignUserToTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    username: zUsername
...
var zAssignUserToTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user was successfully assigned to the tenant."
});
var zSearchUsersForTenantData = import_zod.z.object({
  body: import_zod.z.optional(zTenantUserSearchQueryRequest),
  path: import_zod.z.object({
    tenantId: zTenantId
  }),
  query: import_zod.z.optional(import_zod.z.never())
...
var zSearchClientsForTenantData = import_zod.z.object({
  body: import_zod.z.optional(zTenantClientSearchQueryRequest),
  path: import_zod.z.object({
    tenantId: zTenantId
  }),
  query: import_zod.z.optional(import_zod.z.never())
...
var zSearchGroupIdsForTenantData = import_zod.z.object({
  body: import_zod.z.optional(zTenantGroupSearchQueryRequest),
  path: import_zod.z.object({
    tenantId: zTenantId
  }),
  query: import_zod.z.optional(import_zod.z.never())
...
var zSearchRolesForTenantData = import_zod.z.object({
  body: import_zod.z.optional(zRoleSearchQueryRequest),
  path: import_zod.z.object({
    tenantId: zTenantId
  }),
  query: import_zod.z.optional(import_zod.z.never())
...
var zUnassignClientFromTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    clientId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The unique identifier of the application."
    })
  }),
  query: import_zod.z.optional(import_zod.z.never())
});
var zUnassignClientFromTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The client was successfully unassigned from the tenant."
});
var zAssignClientToTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    clientId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zAssignClientToTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The client was successfully assigned to the tenant."
});
var zUnassignMappingRuleFromTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    mappingRuleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zUnassignMappingRuleFromTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The mapping rule was successfully unassigned from the tenant."
});
var zAssignMappingRuleToTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    mappingRuleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zAssignMappingRuleToTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The mapping rule was successfully assigned to the tenant."
});
var zSearchMappingRulesForTenantData = import_zod.z.object({
  body: import_zod.z.optional(zMappingRuleSearchQueryRequest),
  path: import_zod.z.object({
    tenantId: zTenantId
  }),
  query: import_zod.z.optional(import_zod.z.never())
...
var zUnassignGroupFromTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zUnassignGroupFromTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The group was successfully unassigned from the tenant."
});
var zAssignGroupToTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zAssignGroupToTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The group was successfully assigned to the tenant."
});
var zUnassignRoleFromTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zUnassignRoleFromTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was successfully unassigned from the tenant."
});
var zAssignRoleToTenantData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    tenantId: zTenantId,
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zAssignRoleToTenantResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was successfully assigned to the tenant."
});
var zSearchTenantsData = import_zod.z.object({
  body: import_zod.z.optional(zTenantSearchQueryRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchTenantsResponse = zTenantSearchQueryResult;
var zCompleteUserTaskData = import_zod.z.object({
  body: import_zod.z.optional(zUserTaskCompletionRequest),
  path: import_zod.z.object({
    userTaskKey: zUserTaskKey
  }),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCompleteUserTaskResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user task was completed successfully."
});
var zAssignUserTaskData = import_zod.z.object({
...
var zAssignUserTaskResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user task's assignment was adjusted."
});
var zGetUserTaskData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    userTaskKey: zUserTaskKey
  }),
...
var zUpdateUserTaskData = import_zod.z.object({
  body: import_zod.z.optional(zUserTaskUpdateRequest),
  path: import_zod.z.object({
    userTaskKey: zUserTaskKey
  }),
  query: import_zod.z.optional(import_zod.z.never())
});
var zUpdateUserTaskResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user task was updated successfully."
});
var zGetUserTaskFormData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    userTaskKey: zUserTaskKey
  }),
...
var zGetUserTaskFormResponse = import_zod.z.union([
  zFormResult,
  import_zod.z.void().register(import_zod.z.globalRegistry, {
    description: "The user task was found, but no form is associated with it."
  })
]);
var zUnassignUserTaskData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    userTaskKey: zUserTaskKey
  }),
...
var zUnassignUserTaskResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user task was unassigned successfully."
});
var zSearchUserTasksData = import_zod.z.object({
  body: import_zod.z.optional(zUserTaskSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchUserTasksResponse = zUserTaskSearchQueryResult;
var zSearchUserTaskVariablesData = import_zod.z.object({
  body: import_zod.z.optional(zUserTaskVariableSearchQueryRequest),
  path: import_zod.z.object({
    userTaskKey: zUserTaskKey
  }),
...
var zPinClockData = import_zod.z.object({
  body: zClockPinRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zPinClockResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The clock was successfully pinned to the specified time in epoch milliseconds.\n"
});
var zResetClockData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zResetClockResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The clock was successfully reset to the system time."
});
var zSearchProcessDefinitionsData = import_zod.z.object({
  body: import_zod.z.optional(zProcessDefinitionSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchProcessDefinitionsResponse = zProcessDefinitionSearchQueryResult;
var zGetProcessDefinitionData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    processDefinitionKey: zProcessDefinitionKey
  }),
...
var zGetProcessDefinitionXmlResponse = import_zod.z.string().register(import_zod.z.globalRegistry, {
  description: "The XML of the process definition is successfully returned."
});
var zGetStartProcessFormData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    processDefinitionKey: zProcessDefinitionKey
  }),
...
var zGetStartProcessFormResponse = import_zod.z.union([
  zFormResult,
  import_zod.z.void().register(import_zod.z.globalRegistry, {
    description: "The process was found, but no form is associated with it."
  })
]);
var zGetProcessDefinitionStatisticsData = import_zod.z.object({
  body: import_zod.z.optional(zProcessDefinitionElementStatisticsQuery),
  path: import_zod.z.object({
    processDefinitionKey: zProcessDefinitionKey
  }),
  query: import_zod.z.optional(import_zod.z.never())
...
var zGetProcessInstanceSequenceFlowsData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    processInstanceKey: zProcessInstanceKey
  }),
...
var zGetProcessInstanceStatisticsData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    processInstanceKey: zProcessInstanceKey
  }),
...
var zSearchProcessInstancesData = import_zod.z.object({
  body: import_zod.z.optional(zProcessInstanceSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchProcessInstancesResponse = zProcessInstanceSearchQueryResult;
var zSearchProcessInstanceIncidentsData = import_zod.z.object({
  body: import_zod.z.optional(zProcessInstanceIncidentSearchQuery),
  path: import_zod.z.object({
    processInstanceKey: zProcessInstanceKey
  }),
  query: import_zod.z.optional(import_zod.z.never())
...
var zCancelProcessInstanceData = import_zod.z.object({
  body: import_zod.z.optional(zCancelProcessInstanceRequest),
  path: import_zod.z.object({
    processInstanceKey: zProcessInstanceKey
  }),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCancelProcessInstanceResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The process instance is canceled."
});
var zCancelProcessInstancesBatchOperationData = import_zod.z.object({
...
var zResolveIncidentsBatchOperationData = import_zod.z.object({
  body: import_zod.z.optional(zProcessInstanceIncidentResolutionBatchOperationRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
...
var zMigrateProcessInstanceResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
...
var zModifyProcessInstanceResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The process instance is modified."
});
var zGetProcessInstanceCallHierarchyData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    processInstanceKey: zProcessInstanceKey
  }),
...
var zGetProcessInstanceCallHierarchyResponse = import_zod.z.array(zProcessInstanceCallHierarchyEntry).register(import_zod.z.globalRegistry, {
  description: "The call hierarchy is successfully returned."
});
var zSearchElementInstancesData = import_zod.z.object({
  body: import_zod.z.optional(zElementInstanceSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
...
var zSearchDecisionDefinitionsData = import_zod.z.object({
  body: import_zod.z.optional(zDecisionDefinitionSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchDecisionDefinitionsResponse = zDecisionDefinitionSearchQueryResult;
var zGetDecisionDefinitionData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    decisionDefinitionKey: zDecisionDefinitionKey
  }),
...
var zGetDecisionDefinitionXmlData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    decisionDefinitionKey: zDecisionDefinitionKey
  }),
...
var zGetDecisionDefinitionXmlResponse = import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zGetDecisionRequirementsData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    decisionRequirementsKey: zDecisionRequirementsKey
  }),
...
var zGetDecisionRequirementsXmlData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    decisionRequirementsKey: zDecisionRequirementsKey
  }),
...
var zGetDecisionRequirementsXmlResponse = import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zSearchDecisionInstancesData = import_zod.z.object({
  body: import_zod.z.optional(zDecisionInstanceSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
...
var zCreateAuthorizationData = import_zod.z.object({
  body: zAuthorizationRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCreateAuthorizationResponse = zAuthorizationCreateResult;
var zDeleteAuthorizationData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
...
var zDeleteAuthorizationResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The authorization was deleted successfully."
});
var zGetAuthorizationData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    authorizationKey: zAuthorizationKey
  }),
...
var zUpdateAuthorizationData = import_zod.z.object({
  body: zAuthorizationRequest,
  path: import_zod.z.object({
    authorizationKey: zAuthorizationKey
  }),
...
var zUpdateAuthorizationResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The authorization was updated successfully."
});
var zSearchAuthorizationsData = import_zod.z.object({
  body: import_zod.z.optional(zAuthorizationSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchAuthorizationsResponse = zAuthorizationSearchResult;
var zCreateRoleData = import_zod.z.object({
  body: import_zod.z.optional(zRoleCreateRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCreateRoleResponse = zRoleCreateResult;
var zDeleteRoleData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zDeleteRoleResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was deleted successfully."
});
var zGetRoleData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zUpdateRoleData = import_zod.z.object({
...
var zSearchUsersForRoleData = import_zod.z.object({
  body: import_zod.z.optional(zRoleUserSearchQueryRequest),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
    })
...
var zSearchClientsForRoleData = import_zod.z.object({
  body: import_zod.z.optional(zRoleClientSearchQueryRequest),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
    })
...
var zUnassignRoleFromUserData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zUnassignRoleFromUserResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was unassigned successfully from the user."
});
var zAssignRoleToUserData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zAssignRoleToUserResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was assigned successfully to the user."
});
var zUnassignRoleFromClientData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zUnassignRoleFromClientResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was unassigned successfully from the client."
});
var zAssignRoleToClientData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zAssignRoleToClientResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was assigned successfully to the client."
});
var zSearchRolesData = import_zod.z.object({
  body: import_zod.z.optional(zRoleSearchQueryRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchRolesResponse = zRoleSearchQueryResult;
var zUnassignRoleFromGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zUnassignRoleFromGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was unassigned successfully from the group."
});
var zAssignRoleToGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zAssignRoleToGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was assigned successfully to the group."
});
var zSearchGroupsForRoleData = import_zod.z.object({
  body: import_zod.z.optional(zRoleGroupSearchQueryRequest),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
    })
...
var zUnassignRoleFromMappingRuleData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zUnassignRoleFromMappingRuleResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was unassigned successfully from the mapping rule."
});
var zAssignRoleToMappingRuleData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zAssignRoleToMappingRuleResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The role was assigned successfully to the mapping rule."
});
var zSearchMappingRulesForRoleData = import_zod.z.object({
  body: import_zod.z.optional(zMappingRuleSearchQueryRequest),
  path: import_zod.z.object({
    roleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The role ID."
...
var zCreateGroupData = import_zod.z.object({
  body: import_zod.z.optional(zGroupCreateRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCreateGroupResponse = zGroupCreateResult;
var zDeleteGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zDeleteGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The group was deleted successfully."
});
var zGetGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zUpdateGroupData = import_zod.z.object({
...
var zSearchUsersForGroupData = import_zod.z.object({
  body: import_zod.z.optional(zGroupUserSearchQueryRequest),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
    })
...
var zSearchMappingRulesForGroupData = import_zod.z.object({
  body: import_zod.z.optional(zMappingRuleSearchQueryRequest),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zSearchRolesForGroupData = import_zod.z.object({
  body: import_zod.z.optional(zRoleSearchQueryRequest),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zSearchClientsForGroupData = import_zod.z.object({
  body: import_zod.z.optional(zGroupClientSearchQueryRequest),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
    })
...
var zUnassignUserFromGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zUnassignUserFromGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user was unassigned successfully from the group."
});
var zAssignUserToGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zAssignUserToGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The user was assigned successfully to the group."
});
var zUnassignClientFromGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zUnassignClientFromGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The client was unassigned successfully from the group."
});
var zAssignClientToGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zAssignClientToGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The client was assigned successfully to the group."
});
var zUnassignMappingRuleFromGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zUnassignMappingRuleFromGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The mapping rule was unassigned successfully from the group."
});
var zAssignMappingRuleToGroupData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    groupId: import_zod.z.string().register(import_zod.z.globalRegistry, {
      description: "The group ID."
...
var zAssignMappingRuleToGroupResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The mapping rule was assigned successfully to the group."
});
var zSearchGroupsData = import_zod.z.object({
  body: import_zod.z.optional(zGroupSearchQueryRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchGroupsResponse = zGroupSearchQueryResult;
var zCreateMappingRuleData = import_zod.z.object({
  body: import_zod.z.optional(zMappingRuleCreateRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCreateMappingRuleResponse = zMappingRuleCreateResult;
var zDeleteMappingRuleData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    mappingRuleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zDeleteMappingRuleResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The mapping rule was deleted successfully."
});
var zGetMappingRuleData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    mappingRuleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zUpdateMappingRuleData = import_zod.z.object({
  body: import_zod.z.optional(zMappingRuleUpdateRequest),
  path: import_zod.z.object({
    mappingRuleId: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zSearchMappingRuleData = import_zod.z.object({
  body: import_zod.z.optional(zMappingRuleSearchQueryRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchMappingRuleResponse = zMappingRuleSearchQueryResult;
var zPublishMessageData = import_zod.z.object({
  body: zMessagePublicationRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zPublishMessageResponse = zMessagePublicationResult;
var zCorrelateMessageData = import_zod.z.object({
  body: zMessageCorrelationRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCorrelateMessageResponse = zMessageCorrelationResult;
var zSearchCorrelatedMessageSubscriptionsData = import_zod.z.object({
  body: import_zod.z.optional(zCorrelatedMessageSubscriptionSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchCorrelatedMessageSubscriptionsResponse = zCorrelatedMessageSubscriptionSearchQueryResult;
var zSearchMessageSubscriptionsData = import_zod.z.object({
  body: import_zod.z.optional(zMessageSubscriptionSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchMessageSubscriptionsResponse = zMessageSubscriptionSearchQueryResult;
var zCreateDocumentData = import_zod.z.object({
  ...
  query: import_zod.z.optional(import_zod.z.object({
    ...
    documentId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zCreateDocumentsData = import_zod.z.object({
  body: import_zod.z.object({
    files: import_zod.z.array(import_zod.z.string()).min(1).register(import_zod.z.globalRegistry, {
      description: "The documents to upload."
    }),
    metadataList: import_zod.z.optional(import_zod.z.array(zDocumentMetadata).register(import_zod.z.globalRegistry, {
...
var zDeleteDocumentData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
...
var zDeleteDocumentResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The document was deleted successfully."
});
var zGetDocumentData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    documentId: zDocumentId
  }),
  query: import_zod.z.object({
    ...
    contentHash: import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zGetDocumentResponse = import_zod.z.string().register(import_zod.z.globalRegistry, {
  description: "The document was downloaded successfully."
});
var zCreateDocumentLinkData = import_zod.z.object({
  body: import_zod.z.optional(zDocumentLinkRequest),
  path: import_zod.z.object({
    documentId: zDocumentId
  }),
  query: import_zod.z.object({
...
var zCreateUserData = import_zod.z.object({
  body: zUserRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCreateUserResponse = zUserCreateResult;
var zSearchUsersData = import_zod.z.object({
  body: import_zod.z.optional(zUserSearchQueryRequest),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchUsersResponse = zUserSearchResult;
var zDeleteUserData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    username: zUsername
  }),
...
var zDeleteUserResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
...
var zUpdateUserData = import_zod.z.object({
...
var zCreateAdminUserData = import_zod.z.object({
  body: zUserRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCreateAdminUserResponse = zUserCreateResult;
var zSearchIncidentsData = import_zod.z.object({
  body: import_zod.z.optional(zIncidentSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
...
var zGetUsageMetricsData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.object({
    startTime: import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
      description: "The start date for usage metrics, including this date. Value in ISO 8601 format."
    }),
    endTime: import_zod.z.iso.datetime().register(import_zod.z.globalRegistry, {
      description: "The end date for usage metrics, including this date. Value in ISO 8601 format."
    }),
    tenantId: import_zod.z.optional(zTenantId),
    withTenants: import_zod.z.optional(import_zod.z.boolean().register(import_zod.z.globalRegistry, {
...
var zCreateDeploymentData = import_zod.z.object({
  body: import_zod.z.object({
    resources: import_zod.z.array(
      import_zod.z.any().refine(
        (v) => typeof File !== "undefined" && v instanceof File,
        { message: "Expected File (with a filename & extension)" }
      )
    ).nonempty().register(import_zod.z.globalRegistry, {}),
    tenantId: import_zod.z.optional(import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zDeleteResourceData = import_zod.z.object({
  body: import_zod.z.optional(zDeleteResourceRequest),
  path: import_zod.z.object({
...
var zGetResourceContentData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
    resourceKey: zResourceKey
  }),
...
var zGetResourceContentResponse = import_zod.z.string().register(import_zod.z.globalRegistry, {
...
var zCreateElementInstanceVariablesResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The variables were updated."
});
var zActivateAdHocSubProcessActivitiesData = import_zod.z.object({
...
var zActivateAdHocSubProcessActivitiesResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The ad-hoc sub-process instance is modified."
});
var zBroadcastSignalData = import_zod.z.object({
  body: zSignalBroadcastRequest,
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zBroadcastSignalResponse = zSignalBroadcastResult;
var zGetBatchOperationData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.never()),
  path: import_zod.z.object({
...
var zSearchBatchOperationsData = import_zod.z.object({
  body: import_zod.z.optional(zBatchOperationSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
var zSearchBatchOperationsResponse = zBatchOperationSearchQueryResult;
var zCancelBatchOperationData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.unknown()),
  path: import_zod.z.object({
    batchOperationKey: zBatchOperationKey
  }),
  query: import_zod.z.optional(import_zod.z.never())
});
var zCancelBatchOperationResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The batch operation cancel request was created."
});
var zSuspendBatchOperationData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.unknown()),
  path: import_zod.z.object({
    batchOperationKey: zBatchOperationKey
  }),
...
var zSuspendBatchOperationResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The batch operation pause request was created."
});
var zResumeBatchOperationData = import_zod.z.object({
  body: import_zod.z.optional(import_zod.z.unknown()),
  path: import_zod.z.object({
    batchOperationKey: zBatchOperationKey
  }),
...
var zResumeBatchOperationResponse = import_zod.z.void().register(import_zod.z.globalRegistry, {
  description: "The batch operation resume request was created."
});
var zSearchBatchOperationItemsData = import_zod.z.object({
  body: import_zod.z.optional(zBatchOperationItemSearchQuery),
  path: import_zod.z.optional(import_zod.z.never()),
  query: import_zod.z.optional(import_zod.z.never())
});
...
var import_typed_env = require("typed-env");
...
function hydrateConfig(options = {}) {
  ...
  const config = {
    ...
    supportLog: {
      ...
      filePath: rawMap["CAMUNDA_SUPPORT_LOG_FILE_PATH"] || (typeof process !== "undefined" && typeof process.cwd === "function" ? import_node_path.default.join(process.cwd(), "camunda-support.log") : "camunda-support.log")
    },
    __raw: { ...rawMap }
  };
  deepFreeze(config);
...
var CamundaSupportLogger = class {
  ...
  constructor(config) {
    ...
    this.filepath = config.supportLog?.filePath || (typeof process !== "undefined" ? require("path").join(process.cwd(), "camunda-support.log") : "camunda-support.log");
    ...
    if (t === "ZodIntersection") {
      ...
      if (left2?._def?.typeName === "ZodObject" && right2?._def?.typeName === "ZodObject") {
        try {
          ...
          return import_zod2.ZodObject.create(merged);
        } catch {
        }
      }
      cur = left2;
...
function detectExtrasAndMaybeThrow(opts) {
  ...
  if (!schema || !(schema instanceof import_zod4.ZodObject)) return;
  const extras = {};
  const visit = (val, sch, path2) => {
    if (!val || typeof val !== "object") return;
    if (sch instanceof import_zod4.ZodObject) {

...
class FullProcessTest {
    constructor() {
        ...
        this.integrationService = new camunda8_client_1.Camunda8IntegrationService();
     ...
     * 显示活动任务
     */
    async showActiveTasks(processInstanceKey) {
        console.log('📋 当前活动任务:');
        try {
...
//# sourceMappingURL=test-full-process.js.map